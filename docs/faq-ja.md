...
Pyxel Web Launcher、app2html、カスタムタグの 3 つの方法があります。詳しくは [Web 版 Pyxel の使い方](https://kitao.github.io/pyxel/web/web-usage/) を参照してください。
...
MIT ライセンスに従い、ソースコードやライセンス表示用のファイルに著作権およびライセンスの全文を明示すれば、作者の許可を得ることなく自由に販売や配布が可能です。ただし、可能であれば作者へのご連絡やスポンサーによるご支援をいただけるとありがたいです。
